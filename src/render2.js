...
(async () => {
  ...
  if (mode === 'png') {
    ...
    await page.pdf({
      ...
      headerTemplate: '<div style="width:100%;font-family:Georgia,serif;font-size:7.5pt;color:#8a8a8a;padding:0 18mm;display:flex;justify-content:space-between;"><span>Graph Theory &mdash; Practice Session 1, Problems 9&ndash;26</span><span></span></div>',
